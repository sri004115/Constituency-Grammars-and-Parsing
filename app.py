...
st.title("Probabilistic Context-Free Grammar Parser")
st.write("Enter a sentence to parse it using a probabilistic context-free grammar (PCFG):")
# Streamlit code to interact with the user
input_sentence = st.text_input("Enter a sentence:", key="unique_input_key")  # Added key for unique identification
if input_sentence:
